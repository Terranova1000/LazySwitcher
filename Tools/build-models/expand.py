...
# Фильтр для ИСХОДНЫХ словарей: в них знаков препинания посреди слов нет и быть
# не должно. Алфавит модели (build.py) шире — он включает знаки, на которых в
# ЙЦУКЕН сидят буквы, — но обучающие слова через них не проходят, и это верно:
# нулевая частота таких n-грамм и есть тот сигнал, ради которого они добавлены.
ALPHABETS = {
